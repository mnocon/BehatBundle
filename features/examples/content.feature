Feature: Example scenarios showing how to use steps involving Languages, Content Types and Content Items
  ...
  Scenario Outline: Create a Content item and edit specified field
    Given I create <contentTypeName> Content items in root in "eng-GB"
      | name              | short_name          |
      | <contentTypeName> | <contentTypeName>   |
  ...
  Examples:
    | contentTypeName      | valueToSet                                                                  |
    | RichText CT          | EditedField                                                                 |
    | URL CT               | www.ez.no                                                                   |
    | Email CT             | nospam@ez.no                                                                |
    | Textline CT          | TestTextLine                                                                |
    | ISBN CT              | 9783161484100                                                               |
    | Authors CT           | AuthorName,nospam@ez.no                                                     |
    | Text block CT        | TestTextBlock                                                               |
    | Checkbox CT          | true                                                                        |
    | Country CT           | FR                                                                          |
    | Date CT              | 2018-12-31                                                                  |
    | Time CT              | 13:55                                                                       |
    | Float CT             | 2.34                                                                        |
    | Integer CT           | 10                                                                          |
    | Map location CT      | 59.19930,9.61360                                                            |
    | Date and time CT     | 2018-12-31 13:55                                                            |
    | Content relation CT  | /RelationFolder1                                                            |
    | Content relations CT | RelationFolder1,/RelationFolder2                                            |
    | Image CT             | /var/www/ezplatform/vendor/ezsystems/behatbundle/lib/Data/Images/small1.jpg |
    | File CT              | /var/www/ezplatform/vendor/ezsystems/behatbundle/lib/Data/Files/file1.txt   |
    | Media CT             | /var/www/ezplatform/vendor/ezsystems/behatbundle/lib/Data/Videos/video1.mp4 |
